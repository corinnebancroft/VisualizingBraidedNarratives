...
df_chars = pd.read_csv('data/pod/Mar29/podchar.csv')
df_conts = pd.read_csv('data/pod/Mar29/podcont.csv')
df_rels = pd.read_csv('data/pod/Mar29/podrels.csv')
...
date = datetime.now().strftime("%Y%m%d-%HH%MM")
df_no_duplicates.to_csv(f'data/pod/Mar29/pod_StorySpaceEdges_{date}.csv', index=False)
...
date = datetime.now().strftime("%Y%m%d-%HH%MM")
final_human_df.to_csv(f'data/pod/Mar29/podTextSpaceEdges_{date}.csv', index=False)
...
output_file = 'data/pod/Mar29/podExchangesOnlyMar29.csv'
